...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bold-frost-bf15
```

A live public deployment of this template is available at [https://bold-frost-bf15.templates.workers.dev](https://bold-frost-bf15.templates.workers.dev)
